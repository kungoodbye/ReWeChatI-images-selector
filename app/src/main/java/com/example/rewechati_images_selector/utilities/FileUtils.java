...
public class FileUtils {
    ...
    /**
     * 返回应用缓冲文件目录
     * eturns application cache directory.
     * 缓冲文件将会创建在SD卡。
     * Cache directory will be created on SD card
     * <i>("/Android/data/[app_package_name]/cache")</i>
     * 如果有挂载sd卡和拥有相应的权限.
     * if card is mounted and app has appropriate permission. Else -
     * 否则安卓定义缓存目录在设备的文件系统里。
     * Android defines cache directory on device's file system.
     *
     * @param context Application context
     * @return Cache {@link java.io.File directory}.<br />
     * <b>NOTE:</b> Can be null in some unpredictable cases
     * 在一些不可预知的情况下可以为空
     * (if SD card is unmounted and如果sd卡未挂载
